...
export const siteConfig = {
  ...
  description: 'Un espacio de colaboración simbiótica entre la Ingeniería en Computación y el Diseño Gráfico y Multimedia de la Universidad UNE',
  ...
  metadata: {
    ...
    author: 'Universidad UNE',
  },
  
  organization: {
    name: 'Universidad UNE',
    location: 'Guadalajara, Jalisco, México',
    departments: {
      engineering: 'Ingeniería en Computación',
      design: 'Diseño Gráfico y Multimedia'
    }
  },
